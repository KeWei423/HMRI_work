...
def main ():
    ...
    dir="/Users/baymac/Desktop/Data_todo/HABLE/NII/Baseline/SeqBased/report_07"
    matrix = {'ID' : [],
              'Volume (ml)' : []}
...
#     print(data)
    ...
    data.to_csv("/Users/baymac/Desktop/Data_todo/HABLE/NII/Baseline_WMHyper_thr7.csv", index=False)
